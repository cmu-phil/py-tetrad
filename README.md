...
By the way, the [JPype project](https://github.com/jpype-project/jpype) is already quite awesome. One is not of course limited to integrating Tetrad into Python this way; we aim mainly to be giving examples of _how_ it can be done along with some methods for translating datasets, graphs, and such, between Java and Python to make it easier to use Tetrad as part of a Python workflow
