...
By the way, the [JPype project](https://github.com/jpype-project/jpype) is already quite awesome; it is not necessary to use it in the way suggested in py-tetrad, though perhaps py-tetrad can provide a way to get started with it.
