...
The [JPype project](https://github.com/jpype-project/jpype) itself is already quite awesome, and one is not of course limited to integrating Tetrad into Python using JPype in the way we do it here. We aim mainly to be giving examples of _how_ it can be done along with some methods for translating datasets, graphs, and such, between Java and Python to make it easier to use Tetrad as part of a Python workflow. Feel free to borrow as needed.
