...
1. It is necessary to [install a JDK](https://github.com/cmu-phil/tetrad/wiki/Setting-up-Java:-Tutorial-for-Newbies-and-Experts-Alike), preferably the most recent version with long-term support (LTS).
