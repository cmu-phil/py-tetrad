...
1. Finally, you will need to clone this GitHub repository, so if you don't have Git installed, first google and install that, and then in a terminal cd to a directory where you want the cloned project to appear and type (in a Mac--obvious adjustments for other platforms and adjusting the JAVA_HOME path to your version of the JRE/JDK):
