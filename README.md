...
Also, JPype allows Java interfaces to be implemented in Python, which should allow us to use Python scores and tests in Tetrad, though this hasn't been done yet.
