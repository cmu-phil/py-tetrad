...
* We have started a new project, r-tetrad, for R users who wish to access Tetrad without installing Python. The r-tetrad project requires only the installation of R; access to Java is handled internally.
