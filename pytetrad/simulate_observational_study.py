...
D, G, K, sim_ = sim.simulateObservationalStudy(discrete_outcome=True, samp_size=1000)
...
D2, G2, K2, sim2 = sim.simulateObservationalStudy(max_lag=1, samp_size=1000)
print()
...
D3, G3, K3, sim3 = sim.simulateObservationalStudy(num_subjects=5, max_lag=1, samp_size=1000)
