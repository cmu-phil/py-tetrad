...
This is for using py-tetrad in RStudio to run algorithms in R. If you've already done the installation and want to start exploring, see the section, [How to Explore](https://github.com/cmu-phil/py-tetrad/blob/main/pytetrad/R/README.md#how-to-explore) below. 
