...
#### On a Mac, launch RStudio from your Terminal window.
...
#### In RStudio, install the 'reticulate' package. (This only needs to be done once.)
...
#### In RStudio, tell Reticulate/R where your Python installation is located. (This also only needs to be done once).
...
#### Then adjust the path in it to your working directory in the script (if it isn't right already), select all, and run. That should run FGES on the example file and print the graph in PCALG general graph format. 
